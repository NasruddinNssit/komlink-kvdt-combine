...
{
    /// <summary>
    /// Interaction logic for SeatAdult.xaml
    /// </summary>
    /// 


    public partial class SeatAdultUc : UserControl
    {
            ...
            foreach (var seatButton in buttonList)
            {
                seatButton.Click += (sender, args) =>
                {
                    ...
                    if (seatButton.Parent != null && seatButton.Content != null)
                    {
                        ...
                        UserSession.AdultSeat = Convert.ToInt32(seatButton.Content);
                        if (selectedBorder != null)
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //SeatingScreen seatingScreen = FindParent<SeatingScreen>(this, "")
