...
{
    public class pgKomuter_BTnGPaymentForParcel
    {
        ...
        private ParcelLayout _parcelLayout = null;
        ...
        public pgKomuter_BTnGPaymentForParcel(ParcelLayout parcelLayout,Frame frmSubFrame, Border bdSubFrame, Frame frmPrinting, PrintingTemplateScreen printingTemplateScreen) 
        { 
            _frmSubFrame = frmSubFrame;
            _bdSubFrame = bdSubFrame;
            _frmPint = frmPrinting; 
            _printingTemplateScreen = printingTemplateScreen;
            _parcelLayout = parcelLayout;
        ...
        private void _bTnGPaymentPage_OnEndPayment(object sender, EndOfPaymentEventArgs e)
        {
            ...
            void OnEndPaymentThreadWorking()
            {
                try
                {
                    ...
                    {
                        _parcelLayout.Dispatcher.Invoke(new Action(() =>
                        {
