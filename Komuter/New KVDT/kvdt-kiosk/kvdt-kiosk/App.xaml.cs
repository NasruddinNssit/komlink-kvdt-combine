...
namespace kvdt_kiosk
{
    ...
    public partial class App : Application
    {
        ...
        public static AppBTnGSvcEventsHandler appBTnGSvcEventsHandler = null;
        ...
        public static PurchaseTicketScreen _purchaseTicketScreen { get; set; }
        public static ParcelLayout _parcelLayout { get; set; }
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (System.Diagnostics.Process.GetProcessesByName("Komlink").Length > 0)
            {
                while (System.Diagnostics.Process.GetProcessesByName("Komlink").Length > 0)
                {
                    Thread.Sleep(1000);
                }
            }
            ...
            try
            {
                SystemConfig.IsIm30Available = true;
                ...
                //_sysSetting.HashSecretKey = kvdt_kiosk.Properties.Settings.Default.HashSecretKey;
                //_sysSetting.TVMKey = kvdt_kiosk.Properties.Settings.Default.TVMKey;
                //_sysSetting.TimeZoneId = kvdt_kiosk.Properties.Settings.Default.TimeZoneId;
                //_sysSetting.AesEncryptKey = kvdt_kiosk.Properties.Settings.Default.AesEncryptKey;
                ...
                appBTnGSvcEventsHandler = new AppBTnGSvcEventsHandler(NetClientSvc);
                //NetClientServiceForParcel = new NetClientService();
                //AppBTnGSvcEventsHandlerForParcel = new AppBTnGSvcEventsHandlerForParcel(NetClientServiceForParcel);
                try
                {
