            ...
            try
            {
                ...
                if (_currentPageStreamList == null)
                {
                    if (LoadPrintDocument() == false)
                    {
                        ...
                        Log.Information(_logChannel, _currentTransactionNo ?? "*****", "End Printing - No print doc found", "A05", "ImagePrintingTools.PrintPage",
                            "End Printing");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Log.Information(_logChannel, _currentTransactionNo ?? "*****", "End Printing", "A15", "ImagePrintingTools.PrintPage",
                            "End Printing");
            ...
            if (!isBusy)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        Log.Information(_logChannel, transactionNo ?? "*****", "Start Printing ..", "A05", "ImagePrintingTools.ExecutePrinting", 
                           "Start Printing ..");
                    ...
                    catch(Exception ex)
                    {
                        ...
                        Log.Error(_logChannel, "-", ex, "EX01", "ImagePrintingTools.ExecutePrinting", 
                            "Printing (Start) error occured; Error: {ex.Message}");
