/*
 * Refer from https://stackoverflow.com/questions/11506891/how-to-load-the-rsa-public-key-from-file-in-c-sharp/32243171
 */
...
//{
    public class PemKeyUtils
    {
        ...
        public static RSACryptoServiceProvider GetRSAProviderFromText(String pemfile)
        {
            bool isPrivateKeyFile = true;
            string pemstr = pemfile.Trim();
            if (pemstr.StartsWith(pempubheader) && pemstr.EndsWith(pempubfooter))
                isPrivateKeyFile = false;
