...
namespace NssIT.Kiosk.Server.AccessDB.CommandExec
{
    public class GetDepartTripExecution : IAccessCommandExec, IDisposable
    {
        ...
        {
            string methodTag = "GetDepartTripExecution.Execute";
            string domainEntityTag = "Depart Trip List";
            ...
            try
            {
                ...
                if (validDataFound == false)
                {
                    ...
                    uiTripList = new UIDepartTripListAck(commPack.NetProcessId, commPack.ProcessId, DateTime.Now, errData, AppDecorator.Common.TravelMode.DepartOnly)
            ...
            {
                uiTripList = new UIDepartTripListAck(commPack.NetProcessId, commPack.ProcessId, DateTime.Now, null, AppDecorator.Common.TravelMode.DepartOnly) { ErrorMessage = $@"{ex.Message}; (EXIT21656)" };
