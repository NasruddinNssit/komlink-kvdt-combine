...
{
    public class TnGACGCheckinResp : ICardResponse
    {
        /// <summary>
        /// Importance
        /// </summary>
        ...
        public TnGACGCheckinResp(IM30DataModel orgData)
        {
            if (orgData is null)
            ...
            if ((DataError is null) && ((TransactionCodeDef.IsEqualTrans(orgData.TransactionCode, TransactionCodeDef.Entry) == false)))
            {
        ...
        public TnGACGCheckinResp(Exception error)
        {
            IsDataFound = false;
