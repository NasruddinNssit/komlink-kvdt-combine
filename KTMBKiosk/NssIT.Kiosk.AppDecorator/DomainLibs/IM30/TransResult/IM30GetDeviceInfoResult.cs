...
{
    public class IM30GetDeviceInfoResult : IIM30TransResult, IDisposable
    {
        ...
        public IM30GetDeviceInfoResult(IM30DataModel resultData)
        {
            ResultData = resultData;
            IsSuccess = true;
        }

        public IM30GetDeviceInfoResult(Exception error, IM30DataModel resultData)
        {
            ResultData = resultData;
            Error = error;
            IsSuccess = false;
