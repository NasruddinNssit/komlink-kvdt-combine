...
{
    public class IM30CardSettlementResult : IIM30TransResult, IDisposable
    {
        ...
        public IM30CardSettlementResult(IM30DataModel resultData)
        {
            ResultData = resultData;
            IsSuccess = true;
        }

        public IM30CardSettlementResult(Exception error, IM30DataModel resultData)
        {
            ResultData = resultData;
            Error = error;
            IsSuccess = false;
