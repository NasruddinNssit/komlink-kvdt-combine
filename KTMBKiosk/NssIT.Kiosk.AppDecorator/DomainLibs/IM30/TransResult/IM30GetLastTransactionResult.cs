...
{
    public class IM30GetLastTransactionResult : IIM30TransResult, IDisposable
    {
        ...
        public IM30GetLastTransactionResult(IM30DataModel resultData)
        {
            ResultData = resultData;
            IsSuccess = true;
        }

        public IM30GetLastTransactionResult(Exception error, IM30DataModel resultData)
        {
            ResultData = resultData;
            Error = error;
            IsSuccess = false;
