...
{
	[Serializable]
	public class UISalesClientMaintenanceFinishedSubmission : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ClientMaintenanceFinishedSubmission;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }
		public string ErrorMessage { get; set; } = null;
		public CommunicationDirection CommuCommandDirection { get; } = CommunicationDirection.SendOneResponseOne;

		public UISalesClientMaintenanceFinishedSubmission(string processId, DateTime timeStamp)
		{
