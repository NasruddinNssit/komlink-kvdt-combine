...
{
	[Serializable]
	public class UIKomuterCompletePaymentAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.KomuterCompletePaymentAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.CompleteKomuterPaymentResult
		/// </summary>
		...
		public UIKomuterCompletePaymentAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData, string machineId)
		{
