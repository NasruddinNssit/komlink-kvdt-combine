...
{
	[Serializable]
	public class UIRestartMachineRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.RestartMachine;
        ...
        public UIRestartMachineRequest(string processId, DateTime timeStamp)
		{
