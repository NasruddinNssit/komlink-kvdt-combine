...
{
	[Serializable]
	public class UISeatReleaseRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.SeatReleaseRequest;
		...
		public UISeatReleaseRequest(string processId, DateTime timeStamp, string transactionNo)
		{
