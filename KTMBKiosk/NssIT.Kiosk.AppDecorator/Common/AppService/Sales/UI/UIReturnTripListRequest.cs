...
{
	[Serializable]
	public class UIReturnTripListRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ReturnTripListRequest;
		...
		public UIReturnTripListRequest(string processId, DateTime timeStamp, DateTime passengerDepartDate, string fromStationCode, string toStationCode)
		{
