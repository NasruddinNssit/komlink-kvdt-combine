...
{
	[Serializable]
	public class UICustInfoPNRTicketTypeAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CustInfoPNRTicketTypeAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }
		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.PassengerPNRTicketTypeResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UICustInfoPNRTicketTypeAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
