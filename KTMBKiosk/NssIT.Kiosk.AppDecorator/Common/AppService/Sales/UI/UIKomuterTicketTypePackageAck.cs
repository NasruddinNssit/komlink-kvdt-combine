...
{
	[Serializable]
	public class UIKomuterTicketTypePackageAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.KomuterTicketTypePackageAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.KomuterTicketTypePackageResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UIKomuterTicketTypePackageAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
