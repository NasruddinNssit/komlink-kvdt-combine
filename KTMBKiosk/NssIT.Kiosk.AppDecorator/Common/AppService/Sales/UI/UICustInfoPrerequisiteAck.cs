...
{
	[Serializable]
	public class UICustInfoPrerequisiteAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CustInfoPrerequisiteAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.GetTicketTypeResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UICustInfoPrerequisiteAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
