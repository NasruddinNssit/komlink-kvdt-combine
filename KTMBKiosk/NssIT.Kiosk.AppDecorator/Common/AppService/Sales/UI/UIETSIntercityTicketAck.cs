...
{
	[Serializable]
	public class UIETSIntercityTicketAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ETSIntercityTicketAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.IntercityETSTicketListResult
		/// </summary>
		public object MessageData { get; private set; } = null;
		public UserSession Session { get; private set; } = null;

		public UIETSIntercityTicketAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
