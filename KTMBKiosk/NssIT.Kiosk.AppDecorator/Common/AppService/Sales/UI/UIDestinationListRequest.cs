...
{
	[Serializable]
	public class UIDestinationListRequest : IKioskMsg, INetCommandDirective
    {
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DestinationListRequest;
		...
		public UIDestinationListRequest(string processId, DateTime timeStamp)
		{
