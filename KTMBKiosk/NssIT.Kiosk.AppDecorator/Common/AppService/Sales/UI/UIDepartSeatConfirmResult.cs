...
{
	[Serializable]
	public class UIDepartSeatConfirmResult : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartSeatConfirmResult;
		...
		public UIDepartSeatConfirmResult(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
