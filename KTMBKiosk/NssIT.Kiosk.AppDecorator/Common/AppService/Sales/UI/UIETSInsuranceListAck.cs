...
{
	[Serializable]
	public class UIETSInsuranceListAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ETSInsuranceListAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.GetInsuranceResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UIETSInsuranceListAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
