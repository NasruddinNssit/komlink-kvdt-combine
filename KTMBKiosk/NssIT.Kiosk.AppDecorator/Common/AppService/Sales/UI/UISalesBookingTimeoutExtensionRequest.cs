...
{
	[Serializable]
	public class UISalesBookingTimeoutExtensionRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.SalesBookingTimeoutExtensionRequest;
		...
		public UISalesBookingTimeoutExtensionRequest(string processId, DateTime timeStamp,
			string bookingId)
		{
