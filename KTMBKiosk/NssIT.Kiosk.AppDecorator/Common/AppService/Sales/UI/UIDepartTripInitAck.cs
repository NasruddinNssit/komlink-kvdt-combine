...
{
	[Serializable]
	public class UIDepartTripInitAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartTripListInitAck;
		...
		public UIDepartTripInitAck(Guid? refNetProcessId, string processId, DateTime timeStamp, TravelMode tripMode)
		{
