...
{
	/// <summary>
	/// This class design refer to KTMB Komuter
	/// </summary>
	[Serializable]
	public class UISalesStartSellingAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.StartSellingAck;
		...
		public UISalesStartSellingAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
