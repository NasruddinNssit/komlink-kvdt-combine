...
{
	[Serializable]
	public class UIDepartTripListRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartTripListRequest;
		...
		public UIDepartTripListRequest(string processId, DateTime timeStamp, DateTime passengerDepartDate, string fromStationCode, string toStationCode)
		{
