...
{
    [Serializable]
    public class UITravelDatesEnteringAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.TravelDatesEnteringAck;
		...
		public UITravelDatesEnteringAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
