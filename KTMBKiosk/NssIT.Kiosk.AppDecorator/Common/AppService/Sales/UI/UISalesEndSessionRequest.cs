...
{
	[Serializable]
	public class UISalesEndSessionRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.SalesEndSessionRequest;
		...
		public UISalesEndSessionRequest(string processId, DateTime timeStamp)
		{
