...
{
	[Serializable]
	public class UIDestinationListAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DestinationListAck;
		...
		public UIDestinationListAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
