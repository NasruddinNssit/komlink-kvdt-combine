...
{
	[Serializable]
	public class UIDepartSeatListAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartSeatListAck;
		...
		public UIDepartSeatListAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
