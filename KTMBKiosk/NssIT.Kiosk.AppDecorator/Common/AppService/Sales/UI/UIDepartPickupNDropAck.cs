...
{
	[Serializable]
	public class UIDepartPickupNDropAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartPickupNDropAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Kiosk.AppDecorator.Common.AppService.Sales.PickupNDropList
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UIDepartPickupNDropAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
