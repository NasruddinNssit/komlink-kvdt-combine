...
{
	[Serializable]
	public class UIReturnTripInitAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ReturnTripListInitAck;
		...
		public UIReturnTripInitAck(Guid? refNetProcessId, string processId, DateTime timeStamp, TravelMode tripMode)
		{
