...
{
    [Serializable]
    public class UICountDownExpiredAck : IKioskMsg
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CountDownExpiredAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		public UICountDownExpiredAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
