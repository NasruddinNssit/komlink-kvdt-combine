...
{
	[Serializable]
	public class UIDepartSeatConfirmFailAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartSeatConfirmFailAck;
		...
		public UIDepartSeatConfirmFailAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
