...
{
	[Serializable]
	public class UIKomuterResetUserSessionRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.KomuterResetUserSessionRequest;
		...
		public UIKomuterResetUserSessionRequest(string processId, DateTime timeStamp)
		{
