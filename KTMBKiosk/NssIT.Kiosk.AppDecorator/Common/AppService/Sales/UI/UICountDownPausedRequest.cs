...
{
	[Serializable]
	public class UICountDownPausedRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CountDownPausedRequest;
		...
		public UICountDownPausedRequest(string processId, DateTime timeStamp)
		{
