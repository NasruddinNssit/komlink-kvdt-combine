...
{
	[Serializable]
	public class UICustInfoAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CustInfoAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }
		public string ErrorMessage { get; set; } = null;
		//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.GetTicketTypeResult
		/// </summary>
		public object MessageData { get; private set; } = null;
		public UserSession Session { get; private set; } = null;
		public UICustInfoAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
