...
{
	[Serializable]
	public class UIReturnSeatSubmission : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ReturnSeatSubmission;
		...
		public UIReturnSeatSubmission(string processId, DateTime timeStamp, CustSeatDetail[] custSeatDetailList, string trainSeatModelId)
		{
