...
{
	[Serializable]
	public class UIReturnSeatConfirmResult : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ReturnSeatConfirmResult;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.BookingResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UIReturnSeatConfirmResult(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
