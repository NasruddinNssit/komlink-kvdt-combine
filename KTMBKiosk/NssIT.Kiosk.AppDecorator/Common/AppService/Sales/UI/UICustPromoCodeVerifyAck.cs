...
{
	[Serializable]
	public class UICustPromoCodeVerifyAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CustPromoCodeVerifyAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.PromoCodeVerifyResult
		/// </summary>
		public object MessageData { get; private set; } = null;

		public UserSession Session { get; private set; } = null;

		public UICustPromoCodeVerifyAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
