...
{
	[Serializable]
	public class UIKomuterBookingCheckoutRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.KomuterBookingCheckoutRequest;
		...
		public UIKomuterBookingCheckoutRequest(string processId, DateTime timeStamp,
			string bookingId,
			decimal totalAmount,
