...
{
	[Serializable]
	public class UIReturnSeatConfirmFailAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.ReturnSeatConfirmFailAck;
		...
		public UIReturnSeatConfirmFailAck(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
