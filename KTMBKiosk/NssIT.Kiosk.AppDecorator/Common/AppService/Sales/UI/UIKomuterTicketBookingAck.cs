...
{
	[Serializable]
	public class UIKomuterTicketBookingAck : IKioskMsg, IUserSession
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.KomuterTicketBookingAck;
		public string InstructionDesc { get => Enum.GetName(typeof(CommInstruction), Instruction); }

		public string ErrorMessage { get; set; } = null;

		/// <summary>
		/// return NssIT.Train.Kiosk.Common.Data.Response.KomuterBookingResult
		/// </summary>
		public object MessageData { get; private set; } = null;
		public UserSession Session { get; private set; } = null;

		public UIKomuterTicketBookingAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData)
		{
