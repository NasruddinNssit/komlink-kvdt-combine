...
{
	[Serializable]
	public class UIDepartTripListAck : IKioskMsg, IUserSession
    {
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.DepartTripListAck;
		...
		public TravelMode TripMode { get; private set; } = TravelMode.DepartOnly;

		public UIDepartTripListAck(Guid? refNetProcessId, string processId, DateTime timeStamp, object messageData, TravelMode tripMode)
		{
			RefNetProcessId = refNetProcessId;
			ProcessId = processId;
			TimeStamp = timeStamp;
			MessageData = messageData;
			TripMode = TravelMode.DepartOnly;
		}
