...
{
	[Serializable]
	public class UISalesCheckOutstandingCardSettlementRequest : IKioskMsg, INetCommandDirective
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UISalesInst.CheckOutstandingCardSettlementRequest;
		...
		public UISalesCheckOutstandingCardSettlementRequest(string processId, DateTime timeStamp)
		{
