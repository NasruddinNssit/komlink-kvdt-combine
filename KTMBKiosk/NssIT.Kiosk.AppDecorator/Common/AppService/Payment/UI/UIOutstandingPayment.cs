...
{
	[Serializable]
	public class UIOutstandingPayment : IKioskMsg
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)AppService.Instruction.UIPaymInstruction.ShowOutstandingPayment;
		...
		public UIOutstandingPayment(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
