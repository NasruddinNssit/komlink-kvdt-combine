...
{
	[Serializable]
	public class UIError : IKioskMsg
	{
		...
		public CommInstruction Instruction { get; } = (CommInstruction)UIPaymInstruction.ShowErrorMessage;
		...
		public UIError(Guid? refNetProcessId, string processId, DateTime timeStamp)
		{
