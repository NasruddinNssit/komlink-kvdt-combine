...
using NssIT.Train.Kiosk.Security.LocalHost.BTnG;
using System;
...
{
    public class LocalHostRegistrySetting
    {
        private string CustomMsgTag = "##CUSTOM_MSG##";
        public WebAPISiteCode WebAPICode => WebAPISiteCode.Local_Host;
        ...
        private void VerifyBTnGRegistry()
        {
            ...
            IBTnGGuardInfo guard = BTnGLocalHostGuard.GuardInfo;
