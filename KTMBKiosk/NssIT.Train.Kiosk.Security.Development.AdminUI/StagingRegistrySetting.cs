...
using NssIT.Train.Kiosk.Security.Staging.BTnG;
using System;
...
{
    public class StagingRegistrySetting
    {
        private string CustomMsgTag = "##CUSTOM_MSG##";
        public WebAPISiteCode WebAPICode => WebAPISiteCode.Staging;
        ...
        private void VerifyBTnGRegistry()
        {
            ...
            IBTnGGuardInfo guard = BTnGStagingGuard.GuardInfo;
